        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card card-outline card-info">
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form id="header" action="<?= base_url() ?>admin/ocs/update_header" enctype="multipart/form-data" method="post">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-outline card-info">
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form id="profile_form" action="<?= base_url() ?>admin/ocs/update_profile" enctype="multipart/form-data" method="post">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group pt-4">
                                        <input type="hidden" id="id" name="id" value="<?= $ocs->id_ocs ?>">
                                        <input type="hidden" name="gambar_lama" value="<?= $ocs->img_feature ?>">
                                        <label for="feature">Header One-Coin Service EN</label>
                                        <input type="text" name="feature" value="<?= $ocs->feature ?>" class="form-control" placeholder="Header Profile">
                                    </div>
                                    <div class="form-group pt-2">
                                        <label for="konten">One-Coin Service EN</label>
                                        <textarea id="konten" name="konten" class="form-control" placeholder="Profile" rows="14"><?= $ocs->sub_feature ?></textarea>
                                    </div>
                                </div>
                                    ...
                                    foreach ($type as $data) { ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a title="Hapus" class="btn btn-outline-danger alert_notif" href="<?php echo base_url() ?>admin/ocs/delete_type/<?php echo $data->id_type ?>"><i class="fas fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php }
                                    ?>
            ...
            <div class="col-md-12">
                <div class="card card-outline card-info">
                    ...
                    <div class="card-header">
                        ...
                        <form action="<?= base_url() ?>admin/ocs/update_bg" enctype="multipart/form-data" method="post">
                        ...
                        <hr>
                        <form action="<?= base_url() ?>admin/ocs/update_header_feature_en" enctype="multipart/form-data" method="post">
                            <div class="form-group ">
                                        ...
                                        foreach ($feature as $data) { ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a title="Hapus" class="btn btn-outline-danger alert_notif" href="<?php echo base_url() ?>admin/ocs/delete_feature_en/<?php echo $data->id_feature ?>"><i class="fas fa-trash"></i></a>
                                                </td>
                                            </tr>
                                        <?php }
                                        ?>
...
<script>
    ...
    function edit_feature(id) {
        ...
        $.ajax({
            url: "<?php echo site_url('admin/ocs/ajax_feature_en') ?>/" + id,
            type: "GET",
            dataType: "JSON",
    ...
    function edit_type(id) {
        ...
        //Ajax Load data from ajax
        $.ajax({
            url: "<?php echo site_url('admin/ocs/ajax_type_us') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data) {
...
<div class="modal fade text-left" id="default2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="form2" enctype="multipart/form-data" action="<?php echo base_url() ?>admin/ocs/add_type" method="post">
...
<div class="modal fade text-left" id="default" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="form1" enctype="multipart/form-data" action="<?php echo base_url() ?>admin/ocs/update_type" method="post">
                <div class="modal-body">
...
<div class="modal fade text-left" id="feature_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="feature" enctype="multipart/form-data" action="<?php echo base_url() ?>admin/ocs/add_feature_en" method="post">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="header">Header</label>
                        <input type="text" name="header" class="form-control" id="header">
...
<div class="modal fade text-left" id="edit_feature" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="edit_feature_form" enctype="multipart/form-data" action="<?php echo base_url() ?>admin/ocs/update_feature_en" method="post">
                <div class="modal-body">
                    <input type="hidden" name="id" value="">
