        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card card-outline card-info">
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form id="header" action="<?= base_url() ?>admin/ocs/update_header_id" enctype="multipart/form-data" method="post">
                            <label for="">Header One-Coin Service</label>
                            <input type="hidden" id="id" name="id" value="<?= $ocs->id_ocs ?>">
                            <input type="hidden" name="gambar_lama" value="<?= $ocs->img_header ?>">
                            <div class="form-group text-center">
                                <img width="300px" id="previewImg" src="<?= base_url() ?>assets/assets/img/<?= $ocs->img_header ?>" alt="" srcset="">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-outline card-info">
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form id="profile_form" action="<?= base_url() ?>admin/ocs/update_profile_id" enctype="multipart/form-data" method="post">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group pt-4">
                                        <input type="hidden" id="id" name="id" value="<?= $ocs->id_ocs ?>">
                                        <input type="hidden" name="gambar_lama" value="<?= $ocs->img_feature ?>">
                                        <label for="feature">Header One-Coin Service ID</label>
                                        <input type="text" name="feature" value="<?= $ocs->feature_id ?>" class="form-control" placeholder="Header Profile">
                                    </div>
                                    <div class="form-group pt-2">
                                        <label for="konten">One-Coin Service ID</label>
                                        <textarea id="konten" name="konten" class="form-control" placeholder="Profile" rows="14"><?= $ocs->sub_feature_id ?></textarea>
                                    </div>
                                </div>
                                <div class="col-md-6 mt-4">
                                    ...
                                    <div class="text-center mb-4">
                                        <input type="hidden" name="gambar_lama" value="<?= $ocs->img_feature ?>">
                                        <img width="300px" src="<?= base_url() ?>assets/assets/img/<?= $ocs->img_feature ?>" class="image-fluid" id="image-preview" alt="image preview">
                                    </div>
                                    ...
                                    foreach ($type as $data) { ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a title="Hapus" class="btn btn-outline-danger alert_notif" href="<?php echo base_url() ?>admin/ocs/delete_type_id/<?php echo $data->id_type ?>"><i class="fas fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php }
                                    ?>
            ...
            <div class="col-md-12">
                <div class="card card-outline card-info">
                    ...
                    <div class="card-header">
                        ...
                        <form action="<?= base_url() ?>admin/ocs/update_bg_id" enctype="multipart/form-data" method="post">
                            ...
                            <div class="form-group">
                                <div class="text-center mb-4">
                                    <input type="hidden" id="id" name="id" value="<?= $ocs->id_ocs ?>">
                                    <input type="hidden" name="gambar_lama" value="<?= $ocs->bg ?>">
                                    <img width="300px" src="<?= base_url() ?>assets/assets/img/<?= $ocs->bg ?>" class="image-fluid" id="image-preview3" alt="image preview">
                                </div>
                                <div class="custom-file">
                                    <input type="file" required name="gambar" id="image-source3" class="custom-file-input" accept="image/x-png,image/jpg,image/jpeg" onchange="previewImage3();">
                                    <label class="custom-file-label" for="gallery-photo-add">Pilih Gambar</label>
                                    <small id="helpId" class="text-muted">*Maksimal 1 mb</small>
                                </div>
                            </div>
                        ...
                        <hr>
                        <form action="<?= base_url() ?>admin/ocs/update_header_feature_id" enctype="multipart/form-data" method="post">
                            <div class="form-group ">
                                        ...
                                        foreach ($feature as $data) { ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a title="Hapus" class="btn btn-outline-danger alert_notif" href="<?php echo base_url() ?>admin/ocs/delete_feature_id/<?php echo $data->id_feature ?>"><i class="fas fa-trash"></i></a>
                                                </td>
                                            </tr>
                                        <?php }
                                        ?>
...
<script>
    ...
    function edit_feature(id) {
        ...
        $.ajax({
            url: "<?php echo site_url('admin/ocs/ajax_feature_id') ?>/" + id,
            type: "GET",
            dataType: "JSON",
    ...
    function edit_type(id) {
        ...
        //Ajax Load data from ajax
        $.ajax({
            url: "<?php echo site_url('admin/ocs/ajax_type_id') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data) {
...
<div class="modal fade text-left" id="default2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="form2" enctype="multipart/form-data" action="<?php echo base_url() ?>admin/ocs/add_type_id" method="post">
...
<div class="modal fade text-left" id="default" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="form1" enctype="multipart/form-data" action="<?php echo base_url() ?>admin/ocs/update_type_id" method="post">
                <div class="modal-body">
...
<div class="modal fade text-left" id="feature_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="feature" enctype="multipart/form-data" action="<?php echo base_url() ?>admin/ocs/add_feature_id" method="post">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="header">Header</label>
                        <input type="text" name="header" class="form-control" id="header">
...
<div class="modal fade text-left" id="edit_feature" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="edit_feature_form" enctype="multipart/form-data" action="<?php echo base_url() ?>admin/ocs/update_feature_id" method="post">
                <div class="modal-body">
                    <input type="hidden" name="id" value="">
