            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card card-outline card-info">
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form id="header" action="<?= base_url() ?>admin/resource/update_header" enctype="multipart/form-data" method="post">
                                        ...
                                        foreach ($resource_us as $data) { ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a title="Hapus" class="btn btn-outline-danger alert_notif" href="<?php echo base_url() ?>admin/resource/delete_resource_en/<?php echo $data->id_blog ?>"><i class="fas fa-trash"></i></a>
                                                </td>
                                            </tr>
                                        <?php  } ?>
                                    </tbody>
                                        ...
                                        foreach ($komen as $data) { ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a title="Hapus" class="btn btn-outline-danger alert_notif" href="<?php echo base_url() ?>admin/resource/delete_komen_us/<?php echo $data->id_komen ?>"><i class="fas fa-trash"></i></a>
                                                </td>
                                            </tr>
                                        <?php  } ?>
                                    </tbody>
...
<div class="modal fade text-left" id="default2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="form2" enctype="multipart/form-data" action="<?php echo base_url() ?>admin/resource/add_resource_en" method="post">
...
<div class="modal fade text-left bd-example-modal-lg" id="default" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <form id="form1" enctype="multipart/form-data" action="<?php echo base_url() ?>admin/resource/update_kategori" method="post">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea required name="isi" class="isi form-control" rows="20" id="isi2"></textarea>
                    </div>
                    <label for="isi">Gambar</label>
                    <div class="text-center mb-4">
                        <img width="250px" class="image-fluid" style="display:none;" id="image-preview2" alt="image preview">
                    </div>
                    <div class="custom-file">
                        <input type="file" required name="img" id="image-source2" class="custom-file-input" accept="image/x-png,image/jpg,image/jpeg" onchange="previewImage2();">
                        <label class="custom-file-label" for="gallery-photo-add">Pilih Gambar</label>
                        <small id="helpId" class="text-muted">*Maksimal 1 mb</small>
                    </div>
                </div>
...
<div class="modal" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="edit-data" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="status" action="<?= base_url() ?>admin/resource/update_status_us" method="post">
                <div class="modal-body">
