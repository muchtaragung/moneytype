                                    ...
                                    foreach ($faq as $data) { ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a title="Hapus" class="btn btn-outline-danger alert_notif" href="<?php echo base_url() ?>admin/contact/delete_faq_id/<?php echo $data->id_faq ?>"><i class="fas fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php }
                                    ?>
...
<script>
    ...
    function edit_faq(id) {
        ...
        $.ajax({
            url: "<?php echo site_url('admin/contact/ajax_faq_id') ?>/" + id,
            type: "GET",
            dataType: "JSON",
...
<div class="modal fade text-left" id="feature_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="feature" enctype="multipart/form-data" action="<?php echo base_url() ?>admin/contact/add_faq_id" method="post">
...
<div class="modal fade text-left" id="edit_feature" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="edit_feature_form" enctype="multipart/form-data" action="<?php echo base_url() ?>admin/contact/update_faq_id" method="post">
                <div class="modal-body">
