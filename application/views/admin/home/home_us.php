                ...
                <div class="col-md-8 offset-md-3">
                    <div class="card text-center" style="width: 30rem;">
                        <div class="card-body">
                            ...
                            <div class="mt-5 pt-5">
                                <a href="javascript:;" data-id="<?php echo $home->id_home ?>" data-image="<?php echo $home->image ?>" data-masthead="<?php echo $home->masthead_us ?>" data-toggle="modal" data-target="#edit-data">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit Home US</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form id="image_contact" action="<?= base_url() ?>admin/home/update_us" method="post" enctype="multipart/form-data">
