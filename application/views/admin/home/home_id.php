        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-outline card-info">
                    ...
                    <div class="card-body">
                        <form action="<?= base_url() ?>admin/home/update_feature_id" method="post">
            ...
            <div class="col-md-12">
                <div class="card card-outline card-info">
                    ...
                    <div class="card-header">
                        ...
                        <form action="<?= base_url() ?>admin/home/update_header_feature2_id" enctype="multipart/form-data" method="post">
                            <div class="form-group ">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-6 mt-5">
                                    <a id="denied" type="button" class="btn btn-danger" href="<?= base_url() ?>admin/home/gambar_denied_id/<?= $status->id_admin ?>">
                                        Tidak tampilkan gambar
                                    </a>
                                    <a id="allow" type="button" class="btn btn-success" href="<?= base_url() ?>admin/home/gambar_allow_id/<?= $status->id_admin ?>">
                                        Tampilkan gambar
                                    </a>
                                </div>
                            ...
                            <div class="row mt-5">
                                <div class="col-md-4">
                                    <div class="card text-center">
                                        <form enctype="multipart/form-data" action="<?= base_url() ?>admin/home/update_feature_ocs_id" method="post">
                                            <div class="card-body">
                                                <?php if ($status->akses == 1) { ?>
                                ...
                                <div class="col-md-4">
                                    <div class="card text-center">
                                        <form enctype="multipart/form-data" action="<?= base_url() ?>admin/home/update_feature_fp_id" method="post">
                                ...
                                <div class="col-md-4">
                                    <div class="card text-center">
                                        <form action="<?= base_url() ?>admin/home/update_feature_mc_id" method="post" enctype="multipart/form-data">
            ...
            <div class="col-md-12">
                <div class="card card-outline card-info">
                    ...
                    <div class="card-header">
                        ...
                        <form action="<?= base_url() ?>admin/home/update_feature3_id" enctype="multipart/form-data" method="post">
                                ...
                                <div class="col-md-4 mb-2">
                                    <div class="card h-100">
                                        <div class="bg-white text-center rounded shadow-sm py-5 px-4 h-100">
                                            ...
                                            <a title="Hapus" class="btn btn-outline-danger alert_notif" href="<?php echo base_url() ?>admin/home/delete_feature4_id/<?php echo $data->id_feature ?>"><i class="fas fa-trash"></i></a>
                                        </div>
                                    </div>
                                </div>
                            <?php  } ?>
            ...
            <div class="col-md-12">
                <div class="card card-outline card-info">
                    ...
                    <div class="card-header">
                        ...
                        <form action="<?= base_url() ?>admin/home/update_feature5_id" enctype="multipart/form-data" method="post">
                            <div class="text-center">
                                <label for="">Background</label>
                            </div>
                            <div class="form-group">
...
<script>
    ...
    function edit_feature4(id) {
        ...
        //Ajax Load data from ajax
        $.ajax({
            url: "<?php echo site_url('admin/home/ajax_feature4_id') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data) {
...
<div class="modal fade text-left" id="default2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="form2" enctype="multipart/form-data" action="<?php echo base_url() ?>admin/home/add_header_id" method="post">
...
<div class="modal" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="edit-data" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="edit_header" action="<?= base_url() ?>admin/home/update_header_id" method="post" enctype="multipart/form-data">
                <div class="modal-body">
...
<div class="modal fade text-left" id="feature_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="feature" enctype="multipart/form-data" action="<?php echo base_url() ?>admin/home/add_feature4_id" method="post">
                <div class="modal-body">
                    <div class="form-group">
...
<div class="modal fade text-left" id="edit_feature" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="edit_feature_form" enctype="multipart/form-data" action="<?php echo base_url() ?>admin/home/update_feature4_id" method="post">
                <div class="modal-body">
