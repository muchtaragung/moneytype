        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card card-outline card-info">
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form id="header" action="<?= base_url() ?>admin/mc/update_header" enctype="multipart/form-data" method="post">
                                    ...
                                    foreach ($feature1 as $data) { ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a title="Hapus" class="btn btn-outline-danger alert_notif" href="<?php echo base_url() ?>admin/mc/delete_feature_en1/<?php echo $data->id_feature ?>"><i class="fas fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php }
                                    ?>
            ...
            <div class="col-md-12">
                <div class="card card-outline card-info">
                    ...
                    <div class="card-header">
                        ...
                        <form action="<?= base_url() ?>admin/mc/update_bg" enctype="multipart/form-data" method="post">
                        ...
                        <hr>
                        <form action="<?= base_url() ?>admin/mc/update_header_feature_en" enctype="multipart/form-data" method="post">
                            <div class="form-group ">
                                        ...
                                        foreach ($feature2 as $data) { ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a title="Hapus" class="btn btn-outline-danger alert_notif" href="<?php echo base_url() ?>admin/mc/delete_feature_en2/<?php echo $data->id_feature ?>"><i class="fas fa-trash"></i></a>
                                                </td>
                                            </tr>
                                        <?php }
                                        ?>
            ...
            <div class="col-md-12">
                <div class="card card-outline card-info">
                    ...
                    <div class="card-header">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <form action="<?= base_url() ?>admin/mc/update_header_feature3_en" enctype="multipart/form-data" method="post">
                                    <div class="text-center">
                                        ...
                                        foreach ($feature3 as $data) { ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a title="Hapus" class="btn btn-outline-danger alert_notif" href="<?php echo base_url() ?>admin/mc/delete_feature_en3/<?php echo $data->id_feature ?>"><i class="fas fa-trash"></i></a>
                                                </td>
                                            </tr>
                                        <?php }
                                        ?>
...
<script>
    ...
    function edit_feature3(id) {
        ...
        $.ajax({
            url: "<?php echo site_url('admin/mc/ajax_feature_en3') ?>/" + id,
            type: "GET",
            dataType: "JSON",
    ...
    function edit_feature(id) {
        ...
        //Ajax Load data from ajax
        $.ajax({
            url: "<?php echo site_url('admin/mc/ajax_feature_en2') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data) {
    ...
    function edit_type(id) {
        ...
        //Ajax Load data from ajax
        $.ajax({
            url: "<?php echo site_url('admin/mc/ajax_feature_us1') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data) {
...
<div class="modal fade text-left" id="default2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="form2" enctype="multipart/form-data" action="<?php echo base_url() ?>admin/mc/add_feature_en1" method="post">
...
<div class="modal fade text-left" id="default" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="form1" enctype="multipart/form-data" action="<?php echo base_url() ?>admin/mc/update_feature_en1" method="post">
                <div class="modal-body">
...
<div class="modal fade text-left" id="feature_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="feature" enctype="multipart/form-data" action="<?php echo base_url() ?>admin/mc/add_feature_en2" method="post">
                <div class="modal-body">
                    <label for="img">Image</label><br>
                    <div class="text-center mb-4">
...
<div class="modal fade text-left" id="edit_feature" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="edit_feature_form" enctype="multipart/form-data" action="<?php echo base_url() ?>admin/mc/update_feature_en2" method="post">
                <div class="modal-body">
                    <input type="hidden" name="id" value="">
                    <input type="hidden" name="gambar_lama" value="">
                    <div class="text-center mb-4">
...
<div class="modal fade text-left" id="feature_modal3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="feature" enctype="multipart/form-data" action="<?php echo base_url() ?>admin/mc/add_feature_en3" method="post">
                <div class="modal-body">
                    <label for="img">Image</label><br>
                    <div class="text-center mb-4">
                        <img width="300px" style="display: none;" class="image-fluid" id="image-preview2" alt="image preview">
...
<div class="modal fade text-left" id="edit_feature3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="edit_feature_form" enctype="multipart/form-data" action="<?php echo base_url() ?>admin/mc/update_feature_en3" method="post">
                <div class="modal-body">
                    <input type="hidden" name="id" value="">
                    <input type="hidden" name="gambar_lama" value="">
                    <div class="text-center mb-4">
