        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card card-outline card-info">
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form id="header" action="<?= base_url() ?>admin/fp/update_header_id" enctype="multipart/form-data" method="post">
            ...
            <div class="col-md-12">
                <div class="card card-outline card-info">
                    ...
                    <div class="card-header">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <form action="<?= base_url() ?>admin/fp/update_header_feature_id1" enctype="multipart/form-data" method="post">
                                    <div class="form-group ">
                                        ...
                                        foreach ($feature1 as $data) { ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a title="Hapus" class="btn btn-outline-danger alert_notif" href="<?php echo base_url() ?>admin/fp/delete_feature_id1/<?php echo $data->id_feature ?>"><i class="fas fa-trash"></i></a>
                                                </td>
                                            </tr>
                                        <?php }
                                        ?>
            ...
            <div class="col-md-12">
                <div class="card card-outline card-info">
                    ...
                    <div class="card-header">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <form action="<?= base_url() ?>admin/fp/update_feature2_id" enctype="multipart/form-data" method="post">
                                    <div class="form-group ">
            ...
            <div class="col-md-12">
                <div class="card card-outline card-info">
                    ...
                    <div class="card-header">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <form action="<?= base_url() ?>admin/fp/update_header_feature_id3" enctype="multipart/form-data" method="post">
                                    <div class="text-center">
                                        <label for="">Image</label>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        foreach ($feature3 as $data) { ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a title="Hapus" class="btn btn-outline-danger alert_notif" href="<?php echo base_url() ?>admin/fp/delete_feature_id3/<?php echo $data->id_feature ?>"><i class="fas fa-trash"></i></a>
                                                </td>
                                            </tr>
                                        <?php }
                                        ?>
                                            ...
                                            foreach ($feature4 as $data) { ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <a title="Hapus" class="btn btn-outline-danger alert_notif" href="<?php echo base_url() ?>admin/fp/delete_feature_id4/<?php echo $data->id_feature ?>"><i class="fas fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                            <?php }
                                            ?>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-outline card-info">
                    <!-- /.card-header -->
                    <div class="card-header">
                        <h4 class="mb-5">Feature 5 ID</h4>
                        <form action="<?= base_url() ?>admin/fp/update_bg_id" enctype="multipart/form-data" method="post">
                            <div class="text-center">
                        ...
                        <hr>
                        <form action="<?= base_url() ?>admin/fp/update_header_feature_id5" enctype="multipart/form-data" method="post">
                            <div class="form-group ">
                                        ...
                                        foreach ($feature5 as $data) { ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a title="Hapus" class="btn btn-outline-danger alert_notif" href="<?php echo base_url() ?>admin/fp/delete_feature_id5/<?php echo $data->id_feature ?>"><i class="fas fa-trash"></i></a>
                                                </td>
                                            </tr>
                                        <?php }
                                        ?>
...
<script>
    ...
    function edit_feature(id) {
        ...
        $.ajax({
            url: "<?php echo site_url('admin/fp/ajax_feature_id1') ?>/" + id,
            type: "GET",
            dataType: "JSON",
    ...
    function edit_feature3(id) {
        ...
        //Ajax Load data from ajax
        $.ajax({
            url: "<?php echo site_url('admin/fp/ajax_feature_id3') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data) {
    ...
    function edit_feature4(id) {
        ...
        //Ajax Load data from ajax
        $.ajax({
            url: "<?php echo site_url('admin/fp/ajax_feature_id4') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data) {
    ...
    function edit_feature5(id) {
        ...
        //Ajax Load data from ajax
        $.ajax({
            url: "<?php echo site_url('admin/fp/ajax_feature_id5') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data) {
                $('[name="id"]').val(data.id_feature);
...
<div class="modal fade text-left" id="feature_modal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="feature" enctype="multipart/form-data" action="<?php echo base_url() ?>admin/fp/add_feature_id1" method="post">
...
<div class="modal fade text-left" id="edit_feature1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="edit_feature_form" enctype="multipart/form-data" action="<?php echo base_url() ?>admin/fp/update_feature_id1" method="post">
                <div class="modal-body">
...
<div class="modal fade text-left" id="feature_modal3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="feature" enctype="multipart/form-data" action="<?php echo base_url() ?>admin/fp/add_feature_id3" method="post">
                <div class="modal-body">
                    <label for="img">Image</label><br>
                    <div class="text-center mb-4">
...
<div class="modal fade text-left" id="edit_feature3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="edit_feature_form" enctype="multipart/form-data" action="<?php echo base_url() ?>admin/fp/update_feature_id3" method="post">
                <div class="modal-body">
                    <input type="hidden" name="id" value="">
                    <input type="hidden" name="gambar_lama" value="">
                    <div class="text-center mb-4">
...
<div class="modal fade text-left" id="feature_modal4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="feature" enctype="multipart/form-data" action="<?php echo base_url() ?>admin/fp/add_feature_id4" method="post">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="header">Header</label>
                        <input type="text" required name="header" class="form-control" id="header">
...
<div class="modal fade text-left" id="edit_feature4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="edit_feature_form" enctype="multipart/form-data" action="<?php echo base_url() ?>admin/fp/update_feature_id4" method="post">
                <div class="modal-body">
                    <input type="hidden" name="id" value="">
                    <div class="form-group">
                        <label for="header">Header</label>
...
<div class="modal fade text-left" id="feature_modal5" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="feature" enctype="multipart/form-data" action="<?php echo base_url() ?>admin/fp/add_feature_id5" method="post">
                <div class="modal-body">
                    <label for="img">Image</label><br>
                    <div class="text-center mb-4">
...
<div class="modal fade text-left" id="edit_feature5" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="edit_feature_form" enctype="multipart/form-data" action="<?php echo base_url() ?>admin/fp/update_feature_id5" method="post">
                <div class="modal-body">
                    <input type="hidden" name="id" value="">
                    <input type="hidden" name="gambar_lama" value="">
                    <div class="text-center mb-4">
