              ...
              <?php } else { ?>
                  ...
                  <div id="selanjutnya" class="row justify-content-center mt-5">
                      <div class="col-md-6 offset-md-3">
                          ...
                          <a type="button" id="prev2" class="prev2 btn btn-outline-warning btn-xl" style="display: none;">Sebelumnya</a>
                  ...
                  <div style="display: none;" id="submit-btn" class="row justify-content-center mt-5">
                      <div class="col-md-9 offset-md-3">
                          <a type="button" id="prev3" class="prev3 btn btn-outline-warning btn-xl" style="display: none;">Sebelumnya</a>
                          <button class="btn btn-outline-warning text-dark btn-xl" id="submitButton" type="submit">Kirimkan Saya Hasil Money Type Quiz</button>
                      </div>
                  </div>
