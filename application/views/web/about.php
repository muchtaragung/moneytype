<section class="page-section text-black mb-0">
    <div class="container">
        <div class="row h-100 align-items-center py-5">
            <div class="col-lg-6">
                <h1 class="display-4">About Vidira</h1>
                <p class="lead text-muted mb-0">"We help align your money with your dream"</p>
            </div>
            <div class="col-lg-6 mt-5 d-lg-block"><img src="<?= base_url() ?>assets/icon/about.svg" alt="" class="img-fluid"></div>
        </div>
    </div>
