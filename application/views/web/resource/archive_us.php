                ...
                <div class="container px-0">
                    <div class="pp-gallery">
                        <div class="card-columns">
                            <?php foreach ($resource_us_archive as $data) { ?>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <?php foreach ($kategori as $data) { ?>
                                        <a style="color: black; background:white" class="btn btn-outline-warning pp-filter-button" href="#" data-filter="<?= $data->nama_kategori ?>"><?= $data->nama_kategori ?></a>
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
