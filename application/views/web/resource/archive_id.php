                ...
                <div class="container px-0">
                    <div class="pp-gallery">
                        <div class="card-columns">
                            <?php foreach ($resource_id_archive as $data) { ?>
                    ...
                    <?php foreach ($recent as $data) { ?>
                        <div class="cardborder-0 mt-3" style="max-width: 540px;">
                            <div class="row no-gutters">
                                <div class="col-md-4">
                                    <a href="<?= base_url() ?>id/resource/artikel/<?= $data->slug ?>"><img src="<?= base_url() ?>assets/assets/blog/<?= $data->img ?>" class="card-img" alt="..."></a>
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <?php foreach ($kategori as $data) { ?>
                                        <a style="color: black; background:white" class="rounded btn btn-outline-warning pp-filter-button" href="#" data-filter="<?= $data->nama_kategori ?>"><?= $data->nama_kategori ?></a>
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
