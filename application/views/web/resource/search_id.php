    ...
    <div class="container-fluid">
        ...
        <div class="row mt-2">
                ...
                <div class="container px-0">
                    <div class="pp-gallery">
                        <div class="card-columns">
                            <?php
                            foreach ($resource_id_search as $data) { ?>
                            ...
                            <?php } ?>
                            <?php if (empty($resource_id_search)) { ?>
            ...
            <div class="col-md-4 mt-3 mb-5">
                <div class="container">
                    <h2 class="mb-5" style="border-bottom:2px solid #ffc107;">Postingan Baru</h2>
                    ...
                    <div class="container">
                        <div class="pp-category-filter">
                            <div class="row">
                                <div class="col-md-12">
                                    <a style="color: black; background:white" class="rounded btn btn-warning" href="<?= base_url() ?>resource">Semua</a>
                                    <?php foreach ($kategori as $data) { ?>
                                        <a style="color: black; background:white" class="rounded btn btn-outline-warning" href="<?= base_url() ?>resource/category/<?= $data->nama_kategori ?>"><?= $data->nama_kategori ?></a>
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
