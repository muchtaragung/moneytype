                            ...
                            <div class="container py-5 px-lg-5 h-100">
                                <div class="row py-5 gx-0 gx-lg-0 h-100">
                                    <div class="col-lg-8 align-self-end">
                                        <h1 class="text-white font-weight-bold"><?= $data->masthead_id ?></h1>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 text-center ">
                    <div class="card shadow-lg h-100">
                        ...
                        <div class="card-footer text-muted mx-auto mb-5">
                            <a href="<?= base_url() ?>id/one-coin-service" class="btn btn-outline-warning text-dark btn-md">LEARN MORE</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 text-center">
                    <div class="card shadow-lg h-100">
                        ...
                        <div class="card-footer text-muted mx-auto mb-5">
                            <a href="<?= base_url() ?>id/financial-planning" class="btn btn-outline-warning text-dark btn-md">LEARN MORE</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 text-center ">
                    <div class="card shadow-lg h-100">
                        ...
                        <div class="card-footer text-muted mx-auto mb-5">
                            <a href="<?= base_url() ?>id/money-coaching" class="btn btn-outline-warning text-dark btn-md"> LEARN MORE</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="mask h-100 w-100" style="background-color: rgba(0, 0, 0, 0.6);">
                <div class="d-flex justify-content-center align-items-center h-100">
                    <div class="text-white">
                        ...
                        <a class="btn btn-warning btn-lg" href="<?= base_url() ?>id/moneytype" role="button">Take the Money Type Quiz</a>
                    </div>
                </div>
            </div>
        </div>
